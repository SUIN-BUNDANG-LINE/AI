...
class EditWithChatService:
    ...
    def edit_survey(self, edit_with_chat_request:EditWithChatRequest):
        ...
        editted_result = self.ai_manager.chat_with_memory(edit_propmt.format(user_prompt=edit_with_chat_request.user_prompt, user_survey_data=edit_with_chat_request.survey_data), edit_with_chat_request.thread_id, parser)
